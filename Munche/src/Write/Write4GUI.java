...
public class Write4GUI {
    ...
    public void Savefilter(History sample) throws IOException
    {
    	...
    	writer.write(sample.choosenbox+","+sample.type+","+sample.id+","+sample.hours1+","+sample.minutes1+","+sample.hours2+","+sample.minutes2+","+sample.lat1+","+sample.lot1+","+sample.lat2+","+sample.lot2+",");
        writer.close();  
    }
